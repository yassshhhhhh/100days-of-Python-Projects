...
while game is True:
    ...
    if play == "y":
        ...
        if user_total == 21:
            print(f"Your final hand: [{ran_card_1}, {ran_card_2}], Current score: {user_total}")
            print(f"Computer's final hand: [{coms_ran_card_1}, {coms_ran_card_2}], Current score: {computer_total}")
            print("Won!, You have Blackjack.")
        elif computer_total == 21:
            print(f"Your final hand: [{ran_card_1}, {ran_card_2}], Current score: {user_total}")
            print(f"Computer's final hand: [{coms_ran_card_1}, {coms_ran_card_2}], Current score: {computer_total}")
            print("Lost!, Opponent has Blackjack.")
        else:
            ...
            if next_turn == 'y':
                ...
                if user_total <= 21 and computer_total <= 21:
                    if user_total > computer_total:
                        ...
                        print(f"Computer's final hand[{coms_ran_card_1}, {coms_ran_card_2}], final score: {computer_total}")
                        print("You win!")
                    elif user_total < computer_total:
                        print(f"Your final hand: [{ran_card_1}, {ran_card_2}], final score: {user_total}")
                        print(f"Computer's final hand[{coms_ran_card_1}, {coms_ran_card_2}], final score: {computer_total}")
